...
export class WidgetsDropdownComponent implements OnInit, AfterContentInit {
  ...
  leaveApplicationsCount: number = 0;
  vacancies: any = [];
  vacanciesCount: number = 0;
  requests: any = [];
  ...
  getLeaveApplications() {
    this.apiService.getLeaveApplications().subscribe((data: any) => {
      this.leaveApplications = data;
      this.leaveApplicationsCount = data.length;
      console.log('Leave Applications', this.leaveApplicationsCount);
    });
  }

  private getVacancies() {
    this.apiService.getVacancies().subscribe((data: any) => {
      this.vacancies = data;
      this.vacanciesCount = data.length;
      console.log('Vacancies', this.vacanciesCount);
    });
  }
  ...
  getRequests() {
    this.apiService.getRequests().subscribe((data: any) => {
      ...
      console.log('Requests', this.requestsCount);
    });
  }
  data: any[] = [];
  options: any[] = [];
